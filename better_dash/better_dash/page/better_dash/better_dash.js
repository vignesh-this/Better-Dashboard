	...
	list_actions: function () {
		...
		$(".list-action").click(function () {
			...
			if (["submit", "update"].includes(action)) {
				...
				if (selected_doctype  == "Sales Invoice" || selected_doctype  ==  "Delivery Note" || selected_doctype  ==  "Purchase Receipt") {
				...
				if (selected_doctype  == "Sales Order" || selected_doctype  ==  "Material Request" || selected_doctype  ==  "Purchase Order") {
